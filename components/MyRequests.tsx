...
// Mock enhanced data for MyRequests
const REQUESTS_DATA: (LeaveRequest & { appliedOnFormatted: string; reasonCategory: string })[] = Array.from({ length: 15 }, (_, i) => ({
  ...
  status: [LeaveStatus.APPROVED, LeaveStatus.PENDING, LeaveStatus.REJECTED, LeaveStatus.CANCELLED][i % 4] as LeaveStatus,
  appliedDate: '2025-01-10',
  appliedOnFormatted: i === 0 ? '2 days ago' : 'Jan 13, 2025',
}));

export const MyRequests = ({ onApply }: { onApply: () => void }) => {
              ...
              {filteredRequests.map((r) => (
                ...
                >
                  ...
                  <td className="px-6 py-5 text-right">
                    <button className="p-2 text-gray-400 hover:text-[#3E3B6F] rounded-lg hover:bg-white transition-all shadow-sm">
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-20 text-center">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <button onClick={onApply} className="text-[#3E3B6F] font-bold text-sm hover:underline">Apply for a leave now</button>
                    </div>
                  </td>
                </tr>
              )}
        ...
        <div className="fixed inset-0 z-[70] overflow-hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-full max-w-[450px] bg-white shadow-2xl animate-in slide-in-from-right duration-300 flex flex-col">
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50/50 grid grid-cols-2 gap-4">
              ...
              {(selectedRequest.status === LeaveStatus.CANCELLED) && (
