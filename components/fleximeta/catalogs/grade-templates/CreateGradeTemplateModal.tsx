...
interface CreateGradeTemplateModalProps {
  open: boolean;
...
export const CreateGradeTemplateModal: React.FC<CreateGradeTemplateModalProps> = ({
  open,
  onOpenChange,
  onSubmit,
  isLoading,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-white">
        <DialogHeader>
          <DialogTitle>Add New Grade Template</DialogTitle>
          <DialogDescription>
            Create a new grade template with salary components.
          </DialogDescription>
        </DialogHeader>
