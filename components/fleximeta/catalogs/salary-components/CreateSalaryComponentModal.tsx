...
interface CreateSalaryComponentModalProps {
  open: boolean;
...
export const CreateSalaryComponentModal: React.FC<CreateSalaryComponentModalProps> = ({
  open,
  onOpenChange,
  onSubmit,
  isLoading,
      ...
      <DialogContent className="sm:max-w-2xl bg-white">
        <DialogHeader>
          ...
          <p className="text-sm text-gray-500">
            Add a new salary component to the catalog for payroll processing
          </p>
        </DialogHeader>
