...
import type { TradeRow, FrontendTradesResponse } from "./types";
...
const TradeListing: React.FC = () => {
  ...
  const {
    ...
    isFetching,
    refetch,
  }: UseQueryResult<FrontendTradesResponse, Error> = useTrades(
    page,
    perPage,
    q
  );
  ...
  const rows: TradeRow[] = React.useMemo(() => {
    if (!data) return [];
    return data.data.map((trade, index) => ({
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                {totalEntries.toLocaleString()} trades registered •
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Search trades by code or name..."
                value={search}
