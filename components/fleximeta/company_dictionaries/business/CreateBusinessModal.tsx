      ...
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto bg-white">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-600">
            Add a new business to your company directory.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="grid md:grid-cols-2 gap-x-3 gap-y-6 grid-cols-1">
            {/* Business Code */}
            <FormField
            ...
            <DialogFooter className="col-span-1 text-end md:col-span-2">
              <Button
                type="button"
                variant="outline"
