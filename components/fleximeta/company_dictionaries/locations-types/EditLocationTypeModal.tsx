// components/EditLocationTypeModal.tsx
...
export const EditLocationTypeModal: React.FC<EditLocationTypeModalProps> = ({
  open,
  onOpenChange,
  onSubmit,
  isLoading,
  ...
  // Populate form when locationType changes
  useEffect(() => {
    if (locationType) {
      form.reset({
      ...
      active: locationType.active === true ? '1' : '0' ,
      });
    }
  }, [locationType, form]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md bg-white">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the details of the location type.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
