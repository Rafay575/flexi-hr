...
export const DeleteCurrencyDialog: React.FC<DeleteCurrencyDialogProps> = ({
  open,
  onOpenChange,
  onConfirm,
  currencyName,
          ...
          <AlertDialogDescription className="pt-2 text-gray-600">
            ...
            <div className="bg-red-50 border border-red-100 rounded-md p-3">
              ...
              <ul className="text-sm text-red-700 list-disc list-inside space-y-1">
                <li>This currency will be removed from all systems</li>
                <li>Existing transactions using this currency may be affected</li>
