...
interface EditCityModalProps {
  ...
  city: any; // The city to be edited
  isLoading: boolean;
}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl bg-white max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Modify the details of the city in the directory.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
                    ...
                    <FormControl>
                      <SearchableSelect
                        ...
                        onChange={(value) => {
                          ...
                          form.setValue('country_code', selectedCountry?.iso2 || '');
                          // Clear state if country changes
                          if (value !== city?.country_id?.toString()) {
                            form.setValue('state_id', '');
                            form.setValue('state_code', '');
                          }
                        }}
                        value={field.value || ''}
                        multiple={false}
                    ...
                    <FormControl>
                      <SearchableSelect
                        ...
                        onChange={(value) => {
                          ...
                          form.setValue('state_code', selectedState?.iso2 || '');
                        }}
                        value={field.value || ''}
                        multiple={false}
                        allowAll={false}
